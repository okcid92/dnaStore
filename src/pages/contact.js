...
import { CONTACTS, getWhatsAppLink } from "@/config";
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16" data-aos="fade-up">
            <h1 className="text-4xl md:text-5xl font-display font-light text-brand-light mb-4 uppercase tracking-widest">
              Contactez <span className="font-bold text-brand-blue">Nous</span>
            </h1>
            <p className="text-brand-muted font-light max-w-2xl mx-auto">
              Une question ? Un besoin spécifique ? Notre équipe est à votre
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-6" data-aos="fade-right">
              <div className="liquid-glass p-8 rounded-sm flex items-start gap-6 group hover:border-brand-blue/30 transition-colors">
                ...
                <div>
                  <h3 className="text-sm font-bold text-brand-light uppercase tracking-widest mb-2">
                    Email
                  </h3>
              ...
              <div className="liquid-glass p-8 rounded-sm flex items-start gap-6 group hover:border-brand-blue/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-brand-blue mt-2 uppercase tracking-widest font-bold">
                    Réponse instantanée
                  </p>
                </div>
              </div>
            ...
            <div className="liquid-glass p-10 rounded-sm" data-aos="fade-left">
              <h2 className="text-xl font-bold text-brand-light mb-8 uppercase tracking-widest border-b border-brand-border pb-4">
                Envoyez-nous un message
              </h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-xs font-bold text-brand-light uppercase tracking-widest mb-3">
                ...
                <button
                  type="submit"
                  className="liquid-button w-full py-4 rounded-sm font-bold uppercase tracking-widest text-white flex items-center justify-center gap-3 text-sm shadow-lg"
                >
                  <i className="fa-brands fa-whatsapp text-xl"></i> Envoyer via
                  WhatsApp
                </button>
              </form>
            </div>
